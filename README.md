...
- As a player, I want to be able to sell a pet from my collection based on its unique selling price, but only when the pet is not currently deployed in one of the five clicker helper slots.
