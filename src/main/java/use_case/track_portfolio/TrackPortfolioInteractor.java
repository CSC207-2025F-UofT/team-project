...
public class TrackPortfolioInteractor implements TrackPortfolioInputBoundary {
     ...
     * TODO: Implement comprehensive gain calculations
     */
    private TrackPortfolioOutputData computeGains(Portfolio portfolio, 
        ...
        double totalUnrealizedGain = 0.0;
        for (Position position : portfolio.getPositions()) {
            Double currentPrice = currentPrices.get(position.getTicker());
            if (currentPrice != null) {
                totalUnrealizedGain += position.unrealizedGain(currentPrice);
            }
            // TODO: Handle missing price data
        }
